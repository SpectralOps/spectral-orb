...
[![CircleCI Orb Version](https://img.shields.io/badge/version-2.1.1-brightgreen)](https://circleci.com/orbs/registry/orb/spectralops/spectral)
...
```yaml
  version: 2.1
  orbs:
    spectral: spectralops/spectral@2.1.1
  jobs:
    build:
      docker:
